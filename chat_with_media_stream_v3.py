...
class ChatApp:
    ...
    def get_ai_response_streaming(self, user_input: str) -> None:
        ...
        try:
            ...
            # Print a newline after the streaming response is complete
            print()
            
            # Add the complete AI response to the message history
            self.messages.append({
                "role": "assistant",
    ...
    def request_streaming_response(self, user_input: str):
        """Start streaming request for AI response."""
        self.is_generating = True
        
        # Start the AI response in a separate thread
        thread = threading.Thread(target=self.get_ai_response_streaming, args=(user_input,))
        thread.daemon = True
        thread.start()
    ...
    def start_chat(self) -> None:
        ...
        while True:
            ...
            self.request_streaming_response(user_input)
